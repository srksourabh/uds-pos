/*
  ...
  1. New Tables
    - `idempotency_keys` - Stores idempotency keys for operation deduplication
    - `monitoring_events` - Stores monitoring events for observability

  2. Security
    - Enable RLS on both tables

  3. Functions
    - check_idempotency_key - Check if operation already processed
    - store_idempotency_key - Store operation result
    - emit_monitoring_event - Log monitoring events
    - get_recent_monitoring_events - Retrieve recent events
*/
