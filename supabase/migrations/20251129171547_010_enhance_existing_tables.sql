/*
  ...
  - warranty_expiry: Manufacturer warranty expiration
  - firmware_version: Current firmware version
  - last_maintenance_date: Most recent maintenance
  - metadata: Flexible JSONB field

  ## Changes to calls table
  - client_contact: Contact person at client
  - client_phone: Client phone number
  - scheduled_time_window: Preferred time window
  - resolution_notes: Engineer's completion notes
  - estimated_duration_minutes: Expected completion time
  - actual_duration_minutes: Actual time taken
  - requires_photo: Photo documentation required flag
  - metadata: Flexible JSONB field

  ## Changes to banks table
  - contact_person: Primary contact at bank
  - contact_email: Bank contact email
  - contact_phone: Bank contact phone
