...
-- Based on actual client data patterns and formats
-- =====================================================
...
-- Matching FSE_Details.csv patterns exactly
-- =====================================================

-- Engineer 1: Bhubaneswar Region
...
-- Engineer 2: Kolkata South Region
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, created_at, updated_at)
...
-- Serial numbers match real Ingenico/VeriFone formats
-- =====================================================
...
-- Call numbers match real patterns exactly
-- =====================================================
...
('sm000001-0000-0000-0000-000000000001', 'd0000001-0000-0000-0000-000000000001', 'issuance', 'warehouse', 'issued', NULL, 'e1111111-1111-1111-1111-111111111111', NULL, 'e1111111-1111-1111-1111-111111111111', 'Stock issuance', 'Soundbox issued for installation', '{"awb_no": "DELHUB123456"}'::jsonb),

-- Device installed at merchant
('sm000002-0000-0000-0000-000000000002', 'd0000001-0000-0000-0000-000000000001', 'status_change', 'issued', 'installed', 'e1111111-1111-1111-1111-111111111111', NULL, 'c0000016-0000-0000-0000-000000000016', 'e1111111-1111-1111-1111-111111111111', 'Installation complete', 'Installed at MO PASANDA FASHION', '{"tid": "SB217622", "mid": "022211000532634"}'::jsonb),
...
-- Device installed
('sm000004-0000-0000-0000-000000000004', 'd0000002-0000-0000-0000-000000000002', 'status_change', 'issued', 'installed', 'e2222222-2222-2222-2222-222222222222', NULL, 'c0000017-0000-0000-0000-000000000017', 'e2222222-2222-2222-2222-222222222222', 'Installation complete', 'Installed at SONAR BANGLA SUPERMART', '{"tid": "SB202153"}'::jsonb),

-- Faulty device returned
('sm000005-0000-0000-0000-000000000005', 'd0000015-0000-0000-0000-000000000015', 'return', 'installed', 'faulty', 'e2222222-2222-2222-2222-222222222222', NULL, NULL, 'e2222222-2222-2222-2222-222222222222', 'Device faulty', 'ICT220-CTLS returned due to NFC failure', '{"defective_reason": "NFC module not working"}'::jsonb),
...
-- Summary Statistics
-- =====================================================
-- Engineers: 5 (Bhubaneswar, Kolkata S, Guwahati, Rourkela, Ranchi)
