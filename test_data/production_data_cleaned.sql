-- =====================================================
-- Production Realistic Test Data - CLEANED VERSION
-- Based on production_realistic_test_data.sql with fixes:
-- 1. Added bank_id to user_profiles for Engineers page
-- 2. Verified all UUIDs are valid format
-- 3. No stock_movements trigger issues
-- =====================================================
...
-- =====================================================
-- ENGINEERS (5 Field Service Engineers)
-- Added bank_id for proper bank display in frontend
-- =====================================================

-- Engineer 1: Bhubaneswar Region (UDSPL1191)
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, created_at, updated_at)
VALUES ('e1111111-1111-1111-1111-111111111111', 'mukesh.sahoo@uds.test', crypt('engineer123', gen_salt('bf')), NOW(), NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

INSERT INTO user_profiles (
  id, email, full_name, phone, role, status, region, active,
  last_location_lat, last_location_lng, bank_id,
  metadata
) VALUES (
  'e1111111-1111-1111-1111-111111111111',
  'mukesh.sahoo@uds.test',
  'Mukesh Sahoo',
  '9937990629',
  'engineer', 'active', 'UDS-BHUBANESWAR', true,
  20.4798355, 85.8206754,
  'b0000001-0000-0000-0000-000000000001',
  '{"emp_id": "UDSPL1191", "designation": "Field Engineer", "coordinator": "Dev Narayan Samal", "city": "CUTTACK", "state": "Odisha", "pin_code": "753001", "coverage_areas": ["CUTTACK", "JAGATSINGHPUR"]}'::jsonb
...
-- Engineer 2: Kolkata South Region (UDSPL1218)
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, created_at, updated_at)
VALUES ('e2222222-2222-2222-2222-222222222222', 'hemanta.pramanik@uds.test', crypt('engineer123', gen_salt('bf')), NOW(), NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO user_profiles (
  ...
  'hemanta.pramanik@uds.test',
  'Hemanta Pramanik',
  '7679588187',
  'engineer', 'active', 'UDS-KOLKATA (S)', true,
  23.3318, 86.2605,
  'b0000001-0000-0000-0000-000000000001',
  '{"emp_id": "UDSPL1218", "designation": "Field Engineer", "coordinator": "Ujjwal Chatterjee", "city": "PURULIYA", "state": "West Bengal", "pin_code": "723102", "coverage_areas": ["PURULIYA"]}'::jsonb
) ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  phone = EXCLUDED.phone,
  region = EXCLUDED.region,
...
-- Engineer 3: Guwahati Region (UDSPL1326)
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, created_at, updated_at)
...
INSERT INTO user_profiles (
  ...
  'Tankeshwar Sahu',
  '8720991951',
  'engineer', 'active', 'UDS-GUWAHATI', true,
  27.4765, 95.0168,
  'b0000001-0000-0000-0000-000000000001',
...
-- Engineer 4: Rourkela Region (UDSPL1195)
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, created_at, updated_at)
...
INSERT INTO user_profiles (
  ...
  'Prabin Kumar Munda',
  '7381441889',
  'engineer', 'active', 'UDS-ROURKELA', true,
  22.0138, 84.0432,
  'b0000001-0000-0000-0000-000000000001',
...
-- Engineer 5: Ranchi Region (UDSPL1373)
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, created_at, updated_at)
...
INSERT INTO user_profiles (
  ...
  'Brahmdeo Mahto',
  '8789276982',
  'engineer', 'active', 'UDS-RANCHI', true,
  23.3520, 85.3155,
  'b0000001-0000-0000-0000-000000000001',
...
('d0000001-0000-0000-0000-000000000001', 'XQZ2111202400894', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB217622", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000002-0000-0000-0000-000000000002', 'XGZ1909202518443', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-KOLKATA (S)', 'e2222222-2222-2222-2222-222222222222', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB202153", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000003-0000-0000-0000-000000000003', 'XGZ1709202502317', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-KOLKATA (S)', 'e2222222-2222-2222-2222-222222222222', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB133327", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
...
('d0000008-0000-0000-0000-000000000008', 'F3601014A808511', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "OD081684", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000009-0000-0000-0000-000000000009', 'F3601014A813429', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-KOLKATA (S)', 'e2222222-2222-2222-2222-222222222222', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "WB076374", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000010-0000-0000-0000-000000000010', 'F3601014A816296', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-KOLKATA (S)', 'e2222222-2222-2222-2222-222222222222', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "WB049932", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),

-- Ingenico Devices
('d0000011-0000-0000-0000-000000000011', '13364WL21273323', 'IWL220', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'Portable GPRS terminal', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 417, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000012-0000-0000-0000-000000000012', '14103CT21749159', 'ICT220', 'b0000001-0000-0000-0000-000000000001', 'warehouse', 'UDS-BHUBANESWAR', NULL, 'Countertop terminal', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 74, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000013-0000-0000-0000-000000000013', '203357303131155318426517', 'MOVE-2500 3GPLUS', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'Mobile POS', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 88, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000014-0000-0000-0000-000000000014', '182957313121062303343096', 'MPOS-LINK2500', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'MPOS device', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 168, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000015-0000-0000-0000-000000000015', '16360CT26156131', 'ICT220-CTLS', 'b0000001-0000-0000-0000-000000000001', 'faulty', 'UDS-KOLKATA (S)', 'e2222222-2222-2222-2222-222222222222', 'NFC terminal - defective', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 44, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India", "defective_reason": "De-Installation Close"}'::jsonb),

-- VeriFone Devices
('d0000016-0000-0000-0000-000000000016', '401-552-061', 'E285 3G BW', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'VeriFone E285', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 191, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000017-0000-0000-0000-000000000017', '286-869-256', 'Vx-520 (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'faulty', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'VeriFone Vx-520 - defective', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 119, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000018-0000-0000-0000-000000000018', '282-357-488', 'Vx-520 (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'VeriFone Vx-520', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 88, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000019-0000-0000-0000-000000000019', '289-794-872', 'Vx-520-CTLS (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'warehouse', 'UDS-BHUBANESWAR', NULL, 'VeriFone NFC terminal', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 60, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000020-0000-0000-0000-000000000020', '261-309-246', 'Vx-520 (DGPRS) CTLS', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'VeriFone GPRS', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 176, "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000021-0000-0000-0000-000000000021', '401-685-961', 'E285 3G BW', 'b0000001-0000-0000-0000-000000000001', 'faulty', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'VeriFone E285 - defective', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 348, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
('d0000022-0000-0000-0000-000000000022', '261-299-916', 'Vx-520-CTLS (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'faulty', 'UDS-KOLKATA (S)', 'e2222222-2222-2222-2222-222222222222', 'Defective unit', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 21, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
...
-- More soundbox devices
('d0000024-0000-0000-0000-000000000024', 'XGZ1909202511092', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-KOLKATA (S)', 'e2222222-2222-2222-2222-222222222222', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB187087", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
...
('d0000027-0000-0000-0000-000000000027', '2841650783', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', 'UDS-BHUBANESWAR', 'e1111111-1111-1111-1111-111111111111', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "OD083601", "owner_type": "Bank Center", "owner_name": "State Bank of India"}'::jsonb),
...
('c0000009-0000-0000-0000-000000000009', 'PPSINKOOR0073214', 'install', 'in_progress', 'b0000001-0000-0000-0000-000000000001', 'MS BAZAR FASHION VATIKA', 'ANANTA NARAYAN DAS', '9777739509', 'STATION ROAD PRAFULLA NAGAR BARIPADA, MAYURBHANJ, ODISHA 757001', 21.9326, 86.7267, NOW(), 'e1111111-1111-1111-1111-111111111111', NOW() - INTERVAL '2 hours', 'high', 'Android POS Installation - Multiple units', '{"mid": "022211900520683", "tid": "OD046294", "fsp_region": "UDS-KOLKATA (R)", "fsp_sub_region": "UDS-BHUBANESWAR", "device_type": "Android", "device_model": "A910s"}'::jsonb),
...
-- =====================================================
-- STOCK MOVEMENTS (safe version without triggers)
-- =====================================================
...
('sm000001-0000-0000-0000-000000000001', 'd0000001-0000-0000-0000-000000000001', 'issuance', 'warehouse', 'issued', NULL, 'e1111111-1111-1111-1111-111111111111', NULL, 'e1111111-1111-1111-1111-111111111111', 'Stock issuance', 'Soundbox issued for installation', '{}'::jsonb),
('sm000002-0000-0000-0000-000000000002', 'd0000001-0000-0000-0000-000000000001', 'status_change', 'issued', 'installed', 'e1111111-1111-1111-1111-111111111111', NULL, 'c0000016-0000-0000-0000-000000000016', 'e1111111-1111-1111-1111-111111111111', 'Installation complete', 'Installed at MO PASANDA FASHION', '{}'::jsonb),
('sm000003-0000-0000-0000-000000000003', 'd0000002-0000-0000-0000-000000000002', 'issuance', 'warehouse', 'issued', NULL, 'e2222222-2222-2222-2222-222222222222', NULL, 'e2222222-2222-2222-2222-222222222222', 'Stock issuance', 'Soundbox issued for installation', '{}'::jsonb),
('sm000004-0000-0000-0000-000000000004', 'd0000002-0000-0000-0000-000000000002', 'status_change', 'issued', 'installed', 'e2222222-2222-2222-2222-222222222222', NULL, 'c0000017-0000-0000-0000-000000000017', 'e2222222-2222-2222-2222-222222222222', 'Installation complete', 'Installed at SONAR BANGLA SUPERMART', '{}'::jsonb),
('sm000005-0000-0000-0000-000000000005', 'd0000015-0000-0000-0000-000000000015', 'return', 'installed', 'faulty', 'e2222222-2222-2222-2222-222222222222', NULL, NULL, 'e2222222-2222-2222-2222-222222222222', 'Device faulty', 'ICT220-CTLS returned due to NFC failure', '{}'::jsonb),
('sm000006-0000-0000-0000-000000000006', 'd0000008-0000-0000-0000-000000000008', 'transfer', 'issued', 'issued', 'e2222222-2222-2222-2222-222222222222', 'e1111111-1111-1111-1111-111111111111', NULL, 'e2222222-2222-2222-2222-222222222222', 'Inter-engineer transfer', 'Transferred for Bhubaneswar area coverage', '{}'::jsonb)
...
-- SUMMARY
-- =====================================================
-- Engineers: 5 (all with bank_id set)
-- Devices: 30 (7 Soundbox, 8 Android, 7 Ingenico, 8 VeriFone)
-- Calls: 20 (8 pending, 7 in_progress, 5 completed)
-- Stock Movements: 6
-- Call-Device Links: 5
-- =====================================================
