-- =====================================================
-- FINAL Production Realistic Test Data for UDS-POS
-- ALL FIXES APPLIED - Ready for Supabase SQL Editor
-- =====================================================
--
-- FIXES APPLIED:
-- 1. Removed 'current_location' column (doesn't exist in schema)
-- 2. Phone numbers converted to E.164 format (+91XXXXXXXXXX)
-- 3. Engineers have bank_id assigned
-- 4. DROP call_number_format constraint (production formats differ)
-- 5. UUIDs replaced with user's actual UUIDs
--
-- Your existing UUIDs:
...
-- =====================================================
-- FIX: Drop call_number format constraint
-- Production uses: PPSINKOOR0073220, FB2560445, RR1210953
-- Schema expected: CALL-2025-0001
-- =====================================================
...
UPDATE user_profiles SET
  ...
  active = true,
  bank_id = 'b0000001-0000-0000-0000-000000000001',
...
-- FIX: Removed 'current_location' column - doesn't exist
-- =====================================================

-- Soundbox Devices (ET389)
INSERT INTO devices (id, serial_number, model, device_bank, status, assigned_to, notes, metadata) VALUES
('d0000001-0000-0000-0000-000000000001', 'XQZ2111202400894', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB217622", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000002-0000-0000-0000-000000000002', 'XGZ1909202518443', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'ea4583ec-e579-45a2-baf8-dbe048d258b2', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB202153", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),
('d0000003-0000-0000-0000-000000000003', 'XGZ1709202502317', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'ea4583ec-e579-45a2-baf8-dbe048d258b2', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB133327", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),
('d0000004-0000-0000-0000-000000000004', 'XGZ1809202517051', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'e4444444-4444-4444-4444-444444444444', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB158523", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-ROURKELA"}'::jsonb),
('d0000005-0000-0000-0000-000000000005', '38250306910163', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'warehouse', NULL, 'Soundbox in stock', '{"brand": "FUJIAN", "part_category": "Unit", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000006-0000-0000-0000-000000000006', '38241212910678', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'warehouse', NULL, 'Soundbox in stock', '{"brand": "FUJIAN", "part_category": "Unit", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-ROURKELA"}'::jsonb),
('d0000007-0000-0000-0000-000000000007', '38250715322116', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'e3333333-3333-3333-3333-333333333333', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB179725", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-GUWAHATI"}'::jsonb),

-- Android POS Devices (A910s)
('d0000008-0000-0000-0000-000000000008', 'F3601014A808511', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "OD081684", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000009-0000-0000-0000-000000000009', 'F3601014A813429', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', 'ea4583ec-e579-45a2-baf8-dbe048d258b2', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "WB076374", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),
('d0000010-0000-0000-0000-000000000010', 'F3601014A816296', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', 'ea4583ec-e579-45a2-baf8-dbe048d258b2', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "WB049932", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),

-- Ingenico Devices
('d0000011-0000-0000-0000-000000000011', '13364WL21273323', 'IWL220', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'Portable GPRS terminal', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 417, "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000012-0000-0000-0000-000000000012', '14103CT21749159', 'ICT220', 'b0000001-0000-0000-0000-000000000001', 'warehouse', NULL, 'Countertop terminal', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 74, "owner_type": "Bank Center", "owner_name": "State Bank of India", "defective_reason": "De-Installation Close", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000013-0000-0000-0000-000000000013', '203357303131155318426517', 'MOVE-2500 3GPLUS', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'Mobile POS', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 88, "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000014-0000-0000-0000-000000000014', '182957313121062303343096', 'MPOS-LINK2500', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'MPOS device', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 168, "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000015-0000-0000-0000-000000000015', '16360CT26156131', 'ICT220-CTLS', 'b0000001-0000-0000-0000-000000000001', 'faulty', 'ea4583ec-e579-45a2-baf8-dbe048d258b2', 'NFC terminal - defective', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 44, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India", "defective_reason": "De-Installation Close", "region": "UDS-KOLKATA (S)"}'::jsonb),

-- VeriFone Devices
('d0000016-0000-0000-0000-000000000016', '401-552-061', 'E285 3G BW', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'VeriFone E285', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 191, "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000017-0000-0000-0000-000000000017', '286-869-256', 'Vx-520 (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'faulty', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'VeriFone Vx-520 - defective', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 119, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000018-0000-0000-0000-000000000018', '282-357-488', 'Vx-520 (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'VeriFone Vx-520', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 88, "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000019-0000-0000-0000-000000000019', '289-794-872', 'Vx-520-CTLS (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'warehouse', NULL, 'VeriFone NFC terminal', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 60, "owner_type": "Bank Center", "owner_name": "State Bank of India", "defective_reason": "Asset Swap Close", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000020-0000-0000-0000-000000000020', '261-309-246', 'Vx-520 (DGPRS) CTLS', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'VeriFone GPRS', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 176, "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000021-0000-0000-0000-000000000021', '401-685-961', 'E285 3G BW', 'b0000001-0000-0000-0000-000000000001', 'faulty', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'VeriFone E285 - defective', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 348, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000022-0000-0000-0000-000000000022', '261-299-916', 'Vx-520-CTLS (PSTN)', 'b0000001-0000-0000-0000-000000000001', 'faulty', 'ea4583ec-e579-45a2-baf8-dbe048d258b2', 'Defective unit', '{"brand": "VeriFone", "part_category": "Unit", "ageing": 21, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),
('d0000023-0000-0000-0000-000000000023', '17013WL25641004', 'IWL220 CTLS', 'b0000001-0000-0000-0000-000000000001', 'warehouse', NULL, 'In stock', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 20, "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),

-- More soundbox devices for testing
('d0000024-0000-0000-0000-000000000024', 'XGZ1909202511092', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'ea4583ec-e579-45a2-baf8-dbe048d258b2', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB187087", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),
('d0000025-0000-0000-0000-000000000025', 'XGZ1809202504964', 'ET389-WIFI', 'b0000001-0000-0000-0000-000000000001', 'issued', 'e3333333-3333-3333-3333-333333333333', 'Soundbox device', '{"brand": "FUJIAN", "part_category": "Unit", "tid": "SB143702", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-GUWAHATI"}'::jsonb),
('d0000026-0000-0000-0000-000000000026', '00001504QR70W032400', 'SR600 Mini DQR', 'b0000001-0000-0000-0000-000000000001', 'issued', 'e3333333-3333-3333-3333-333333333333', 'All in one POS', '{"brand": "SunMI", "part_category": "Unit", "tid": "SB137741", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-GUWAHATI"}'::jsonb),
('d0000027-0000-0000-0000-000000000027', '2841650783', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', '4d41c32a-dd3c-4090-80dd-a1f8a422f6c8', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "OD083601", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-BHUBANESWAR"}'::jsonb),
('d0000028-0000-0000-0000-000000000028', '2841650894', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'warehouse', NULL, 'Android POS in stock', '{"brand": "PAX", "part_category": "Unit", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-KOLKATA (S)"}'::jsonb),
('d0000029-0000-0000-0000-000000000029', '2841650181', 'A910s', 'b0000001-0000-0000-0000-000000000001', 'issued', 'e3333333-3333-3333-3333-333333333333', 'Android POS', '{"brand": "PAX", "part_category": "Unit", "tid": "AS046375", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-GUWAHATI"}'::jsonb),
('d0000030-0000-0000-0000-000000000030', '14324CT22939310', 'ICT220 D-GPRS', 'b0000001-0000-0000-0000-000000000001', 'faulty', 'e3333333-3333-3333-3333-333333333333', 'Defective terminal', '{"brand": "Ingenico", "part_category": "Unit", "ageing": 128, "good_type": "Defect", "owner_type": "Bank Center", "owner_name": "State Bank of India", "region": "UDS-GUWAHATI"}'::jsonb)
...
-- Paper Roll calls (using 'maintenance' type)
...
--
-- FIXES APPLIED:
-- 1. Removed 'current_location' column from devices INSERT (doesn't exist)
-- 2. Phone numbers in E.164 format (+91XXXXXXXXXX)
-- 3. All engineers have bank_id = 'b0000001-...'
-- 4. Dropped call_number_format constraint (production formats differ)
-- 5. UUIDs replaced with your actual UUIDs
