...
export function Approvals() {
  ...
  return (
    <div>
      <div className="mb-responsive flex items-center justify-between">
        <div>
          <h1 className="heading-1-responsive text-gray-900">Pending Approvals</h1>
                ...
                <div className="space-y-3 pt-4 border-t border-gray-200">
                  <div>
                    ...
                    <select
                      ...
                      className="form-input-responsive focus:border-blue-500 outline-none text-sm"
                      required
                    >
